...
const PWAReloadToast: FunctionComponent = () => {
  const {
  ...
  return (
    <div className="fixed bottom-0 right-0 z-50 p-5">
      {needRefresh && (
        <div
          className="flex items-center p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 gap-5"
          role="alert"
        >
          <div className="flex gap-3 items-center">
            ...
            <div className="text-sm font-normal">
              L'applicazione si sta aggiornando
            </div>
          </div>
